...
source_subpath: athanor/livecd-stage1-amd64-@VERSION@-desktop
compression_mode: pixz

portage_confdir: @REPO_DIR@/catalyst/portage
livecd/fsscript: @REPO_DIR@/catalyst/files/fsscript-desktop.sh

livecd/volid: ATHANOROS
livecd/fstype: squashfs
livecd/iso: athanoros-desktop-amd64-@VERSION@.iso
livecd/type: gentoo-release-minimal
livecd/depclean: yes

livecd/bootargs: rd.live.image rd.live.squashimg=athanoros-desktop.squashfs
